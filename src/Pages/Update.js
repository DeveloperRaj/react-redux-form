...
function Update(props) {
  ...
  if (products.length > 0) {
    foundproduct = products.find((v) => v.id === productid);
  } else {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      conditiontype: foundproduct.conditiontype,
      color: foundproduct.color,
      askingprice: foundproduct.askingprice,
      description: foundproduct.description,
      pickimage: foundproduct.pickimage,
    },
